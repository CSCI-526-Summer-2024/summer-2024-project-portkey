...
# Function to create the metric 2 plot
...
def index():
    ...
    plot_url = create_plot(levels, average_scores_left, average_scores_right, 'Levels', 'Average ScoreUp Props Collected across Gameplays', 'ScoreUp Props Collected per Level', 'Left Screen', 'Right Screen')
    ...
    # Metric 3: Usage of Control-Flipping Props
    levels, average_props_left, average_props_right = parse_data(data, 'totalCtrlSwitchPropCollectedLeft', 'totalCtrlSwitchPropCollectedRight')
    plot_url = create_plot(levels, average_props_left, average_props_right, 'Levels', 'Average Control-Flipping Props across Gameplays', 'Usage of Control-Flipping Props', 'Left Screen', 'Right Screen')
    plots.append(f'data:image/png;base64,{plot_url}')
    # Metric 4: Collisions after Control-Flip per Level
    levels, average_collisions_left, average_collisions_right = parse_data(data, 'collisionDueToCtrlFlipLeft', 'collisionDueToCtrlFlipRight')
    plot_url = create_plot(levels, average_collisions_left, average_collisions_right, 'Levels', 'Average Number of Obstacle Collisions across Gameplays', 'Collisions after Control-Flip per Level', 'Left Screen', 'Right Screen')
    plots.append(f'data:image/png;base64,{plot_url}')
